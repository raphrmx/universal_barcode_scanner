...
- On Windows and Linux the webview no longer fills the whole window with a stretched camera. The
  framing moved into the scanner page, where it belongs: the library derives the video and the whole
